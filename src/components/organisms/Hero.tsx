    ...
    <div className={styles.hero}>
      <div className={styles.heroCopy}>
        ...
        <p className={styles.subtitle}>
          A curated knowledge hub for prompt engineering, AI agents, reusable
          patterns, and everyday examples you can copy into ChatGPT, Claude,
          Gemini, or any assistant.
        </p>
